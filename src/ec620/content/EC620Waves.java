...
public class EC620Waves
{
    ...
    public Seq<SpawnGroup> get()
    {
        ...
        {
            spawns = Seq.with(
                    new SpawnGroup(dagger)  //Dagger 1
                    {{
                        end = 10;
                        unitScaling = 2f;
                        max = 30;
                    ...
                    new SpawnGroup(crawler) //Crawler 1
                    {{
                        begin = 4;
                        end = 13;
                        unitAmount = 2;
                    ...
                    new SpawnGroup(spiroct) //Crawler 3
                    {{
                        begin = 45;
                        spacing = 3;
                        unitScaling = 1;
                    ...
                    new SpawnGroup(fortress)    //Dagger 3
                    {{
                        begin = 40;
                        spacing = 5;
                        unitAmount = 2;
                    ...
                    new SpawnGroup(horizon) //Flare 2
                    {{
                        begin = 40;
                        unitAmount = 2;
                        spacing = 2;
                    ...
                    new SpawnGroup(atrax)   //Crawler 2
                    {{
                        begin = 31;
                        unitAmount = 4;
                        unitScaling = 1;
                    ...
                    new SpawnGroup(scepter) //Dagger 4
                    {{
                        begin = 41;
                        unitAmount = 1;
                        unitScaling = 1;
                    ...
                    new SpawnGroup(antumbra)    //Flare 4
                    {{
                        begin = 120;
                        unitAmount = 1;
                        unitScaling = 1;
                    ...
                    new SpawnGroup(toxopid) //Crawler 5
                    {{
                        begin = 210;
                        unitAmount = 1;
                        unitScaling = 1;
